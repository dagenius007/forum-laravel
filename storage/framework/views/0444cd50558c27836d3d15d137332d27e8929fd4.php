    ...
    <div class="row height">
        <div class="settings">
            ...
            <div class="settings__card">
                <form method="POST" action='/profiles/<?php echo e($user->slug); ?>/update' enctype="multipart/form-data">
                    <div class="col-md-6">
                ...
                <div class="modal-body">
                    <form action="/profile/<?php echo e($user->id); ?>/password" method="post">
                        ...
                        <div class="form__field<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                            <div class="form__group">
                                <input id="password" type="password" class="form__input" name="password" placeholder="Password" required>                                <?php if($errors->has('password')): ?>
