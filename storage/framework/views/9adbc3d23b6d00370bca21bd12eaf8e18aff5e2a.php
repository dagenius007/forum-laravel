        ...
        <div class="row">
            <div class="col-md-12 topic">
                <div class="breadcrumbs">
                    HOME / <?php echo e($thread->channel->name); ?> / <?php echo e($thread->title); ?> 
                </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <?php if( $thread->creator): ?>
                            <div class="topic__user-info">
                                <a href="/profiles/<?php echo e($thread->creator->slug); ?>"><?php echo e($thread->creator->name); ?></a> <?php if(Auth::check()): ?>
