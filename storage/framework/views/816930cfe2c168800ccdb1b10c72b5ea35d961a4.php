            ...
            <div class="sidebar">
                ...
                <div class="sidebar__content">
                    <div class="sidebar__content--title">
                        <a href="/threads/<?php echo e($topic->channel->slug); ?>/<?php echo e($topic->slug); ?>" class="white"> <?php echo e(strlen($topic->title) < 10 ? $topic->title : substr($topic->title ,0,10).'.....'); ?></a>
                    </div>
                    <div class="sidebar__content--details">
                        <?php echo e($topic->counts()
