                ...
                <?php $__currentLoopData = $channels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4">
                        <a href="/threads/<?php echo e($channel->name); ?>"> 
                            <div class="category" style="background-image: url(<?php echo e(asset('img/category/'.$channel->channel_img)); ?>)">
                                <div class="category__overlay"></div>
                                <div class="category__content">
                                    <div class="category__title"><?php echo e(ucfirst($channel->name)); ?></div>
                                    <div class="category__number"><?php echo e(count($channel->thread)); ?></div>
                                </div>
                            </div>
                        </a>
                    </div>   
